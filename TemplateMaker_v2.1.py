...
def generateWordTemplate(rejection_data: rejData, app_data: appHead):
    Template = docx.Document("C:/Users/ctroc/Documents/Python/TemplateMaker/OA_Template.docx")
    TemplateFileName = "C:/Users/ctroc/Documents/Python/TemplateMaker/"+app_data.matter+"_OATemplate.docx"
    ...
    Template.paragraphs[11].text = '\tIn response to the Non-Final Office Action dated '+app_data.OAdate+', please amend the present application as set forth below and consider the remarks that follow.'
...
def makeTemplate(*args):
    ...
    generateWordTemplate(OArejData, OA)
...
appWin = makeMainWin()
appWin.bind("<Return>",makeTemplate)
appWin.mainloop()
